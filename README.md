...
There are still issues when sbt-mocha downloads and installs [jsdom](https://github.com/tmpvar/jsdom)
...
- [sbt-mocha: Support for jsdom](https://github.com/sbt/sbt-mocha/issues/11)
